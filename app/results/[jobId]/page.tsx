...
function mapBackendToAnalysis(b: BackendAnalysis): Analysis {
  ...
  return {
    ...
    confidenceScore: typeof arbiter.confidenceScore === "number" ? arbiter.confidenceScore : 75,
    ...
    agentTrace: (b.trace ?? []).map((t: Record<string, unknown>) => ({
      ...
      duration: (t.duration as string) || "0s",
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="ml-11 text-sm text-muted-foreground">
                ...
                &middot; {analysis.confidenceScore}% confidence
              </p>
            </div>
            <Link href="/">
